...
public class PictureBuffer
{
    ...
    private static byte[][] circles = new byte[][]
    {
        new byte[] { 0x80 },
        new byte[] { 0x30 },
        new byte[] { 0x5f, 0xf4 },
        new byte[] { 0x66, 0xff, 0xf6, 0x60 },
        new byte[] { 0x23, 0xbf, 0xff, 0xff, 0xee, 0x20 },
        new byte[] { 0x31, 0xe7, 0x9e, 0xff, 0xff, 0xde, 0x79, 0xe3, 0x00 },
        new byte[] { 0x38, 0xf9, 0xf3, 0xef, 0xff, 0xff, 0xff, 0xfe, 0xf9, 0xf3, 0xe3, 0x80 },
        new byte[] { 0x18, 0x3c, 0x7e, 0x7e, 0x7e, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7e, 0x7e, 0x7e, 0x3c, 0x18 },
    };

    private static byte[] splatterBrushMap = new byte[]
    {
    ...
    private static byte[] splatterBrushStart = new byte[]
    {
