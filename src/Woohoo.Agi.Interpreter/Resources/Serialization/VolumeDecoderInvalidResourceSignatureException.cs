...
namespace Woohoo.Agi.Resources.Serialization
{
    ...
    public class VolumeDecoderInvalidResourceSignatureException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VolumeDecoderInvalidResourceSignatureException"/> class with serialized data.
        /// </summary>
        /// <param name="info">The SerializationInfo that holds the serialized object data about the exception being thrown.</param>
        /// <param name="context">The StreamingContext that contains contextual information about the source or destination.</param>
        protected VolumeDecoderInvalidResourceSignatureException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
